    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnReg.setOnClickListener {
            ...
            if(binding.etRegName.text.toString() != "" && binding.etRegEmail.text.toString() != "" &&
                ...
                if(binding.etRegName.text.toString().length <= 50  && binding.etRegEmail.text.toString().length <= 50 &&
                    binding.etRegUser.text.toString().length <= 50 && binding.etRegPass.text.toString().length <= 50){
