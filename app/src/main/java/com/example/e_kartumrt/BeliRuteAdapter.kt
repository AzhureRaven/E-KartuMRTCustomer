...
class BeliRuteAdapter  (
    var rute: ArrayList<Rute>,
    var context: Context
) : RecyclerView.Adapter<BeliRuteAdapter.CustomViewHolder>(){
        ...
        when(rt.status_rute){
            0 -> {
                ...
                holder.itemView.setOnClickListener{
                    Toast.makeText(context, "Maaf, Rute ini dalam maintanence...", Toast.LENGTH_SHORT).show()
                }
            }
            1 -> {
